...
namespace DiaryJournal.Net
{
    ...
    public class DatabaseIndexing
    {
        ...
        public const string dbIndexingFileName = ".dbIndexing.cfg";
        public const string dbOpenDBIndexingFileName = "dbIndexing.cfg";
        public const string dbOpenDBIndexingExtension = "cfg";

        public static void fromFile(ref DatabaseIndexing dbIndexing, String file)
        {
            String value = File.ReadAllText(file);
            dbIndexing.currentDBIndex = Int64.Parse(value);
        }
        public static void toFile(ref DatabaseIndexing dbIndexing, String file)
        {
            String value = dbIndexing.currentDBIndex.ToString();
